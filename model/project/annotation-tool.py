...
class Display():
	...
	def drawLine(self,pt1,pt2,color=(255,255,255),thickness=1):
		pt1 = self.__pt2xy(pt1)
		pt2 = self.__pt2xy(pt2)
		cv2.line(self.Idisplay,pt1,pt2,color=color,thickness=thickness)

	def drawCircle(self,center,color=(255,255,255),radius=3):
		center = self.__pt2xy(center)
		cv2.circle(self.Idisplay,center,radius,color,thickness=-1)

	def drawText(self,text,bottom_left_pt,color=(255,255,255),bgcolor=(0,0,0),font_size=0):
...
if __name__ == '__main__':
	...
	maxW = int(1920)
	maxH = int(1080)
	image_dir = 'data/to_label/cars_test'
	...
	while curr_image < len(img_files):
		...
		img_file = os.path.join(image_dir, img_files[curr_image])
